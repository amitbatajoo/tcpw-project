...
public class Histogram
{
  ...
  \*------------------------------------------------------------------------*/
  {
    Debug.assertValue(bins>0, "Histogram: number of bins < 0");
  ...
  \*------------------------------------------------------------------------*/
  {
    Debug.assertValue(bin >= 0, "Histogram.Add: bin less than 0.");
  ...
  \*------------------------------------------------------------------------*/
  {
    Debug.assertValue(bin>=0, "Histogram.Bin: bin less than 0.");
